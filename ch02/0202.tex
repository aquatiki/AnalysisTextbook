...
\marginfig[-1in]{tricky}{The function appears to be a decreasing exponential ... or does it?}
...
\marginfig[-1in]{epsilondelta.png}{Whenever a point $x$ is within $\delta$ units of $c$, $f(x)$ is within $\epsilon$ units of $L$ \cite{epsilondelta}.}
...
\marginfig[-1.5in]{Function-1_x.png}{Function $y=\frac{1}{x}$\cite{function1x}.}
\end{example}
...
\marginfig[-1in]{epsilonover5}{$\epsilon-\delta$ around (1,2)}
\begin{align*}
|(5x-3)-2| & < \epsilon \\
|5x-5| & <\epsilon \\
5|x-1| & <\epsilon \\
