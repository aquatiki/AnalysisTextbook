...
\marginfig[-0in]{Linear_Function_Graph.png}{Linear functions.\label{fig:LinearFunction}}
...
\marginfig[-0in]{AndraGrad-4}{A quadratic function is a polynomial of degree two.}
...
\marginfig[-0in]{2^x_function_graph}{$2^x$ is an  exponential function}
...
\inlinefig{Periodic_function_illustration.png}{\label{fig:periodic}A periodic function is so called because it repeats at a given interval, called the period (P).}
